...
# Ensure the tensor for concatenation matches the device of is_negative_100
                starts = (
                    is_negative_100 & ~torch.cat((torch.tensor([False], device=is_negative_100.device), is_negative_100[:-1]))
