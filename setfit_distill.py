...
teacher_model = AutoModelForCausalLM.from_pretrained(teacher_model_name, attn_implementation="flash_attention_2")
teacher_model.eval()  # Freeze teacher parameters

model = AutoModelForCausalLM.from_pretrained(student_model_name, attn_implementation="flash_attention_2")
