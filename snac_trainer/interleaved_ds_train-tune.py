...
project_name = "batched_interleaving-datasets-pretrain"
resize_dataset = True

dsn1 = "amuvarma/orcatext-dev-processed-1"
dsn2 = "amuvarma/snac-2m-tts-combined"
...
wandb.init(project=project_name, name = "10-12-batched-alternating-r3")
